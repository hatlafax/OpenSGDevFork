...
std::string Example::get_fp_program()
{
    ...
    << endl << ""
    << endl << "    float attenuation = shadowAttenuationDirectionalLight(p.z, p_ws, n_ws, current_light);"
    << endl << ""
    ...
    << endl << "    if (uRenderAmbient)  result += Ca;"
    << endl << ""
    << endl << "    attenuation *= shadowAttenuationPointLight(p.z, p_ws, n_ws, current_light);"
    << endl << ""
    << endl << "    if (uRenderDiffuse)  result += attenuation * Cd;"
    << endl << "    if (uRenderSpecular) result += attenuation * Cs;"
    << endl << ""
    ...
    << endl << "    if (uRenderAmbient)  result += Ca;"
    << endl << ""
    << endl << "    attenuation *= shadowAttenuationSpotLight(p.z, p_ws, n_ws, current_light);"
    << endl << ""
    << endl << "    if (uRenderDiffuse)  result += attenuation * Cd;"
    << endl << "    if (uRenderSpecular) result += attenuation * Cs;"
    << endl << ""
