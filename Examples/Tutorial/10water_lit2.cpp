...
//     geo->setColors   (colors );
    ...
    OSG::DirectionalLightRecPtr pLight              = OSG::DirectionalLight::create();
    ...
    // positions does not apply, but direction instead
//     pLight->setPosition(Pnt3f(0,0,0));
    pLight->setDirection (OSG::Vec3f(0,1,0));
    
    // Attenuation parameters -- do not apply to directional light
//     pLight->setConstantAttenuation(1);
//     pLight->setLinearAttenuation(0);
//     pLight->setQuadraticAttenuation(0);
    
    // color information
    pLight->setDiffuse (OSG::Color4f(1.0f, 1.0f, 1.0f, 1.0f));
    pLight->setAmbient (OSG::Color4f(0.2f, 0.2f, 0.2f, 1.0f));
    pLight->setSpecular(OSG::Color4f(1.0f, 1.0f, 1.0f, 1.0f));
