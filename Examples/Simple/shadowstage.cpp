// OpenSG Example: ShadowStage
//
// This examples shows the usage of the ShadowStage that works with the 
// standard OpenSG - Lights.
//
...
int doMain(int argc, char **argv)
{
    ...
    _light1_trans->editMatrix().setTranslate(0.f, 0.f, 0.f);
    _light1_core->setDirection(0.8f, 0.8f, 0.5f);
    _light1_core->setAmbient(0.15f, 0.15f, 0.15f, 1.f);
    _light1_core->setDiffuse(0.4f, 0.4f, 0.4f, 1.f);
    _light1_core->setSpecular(0.f, 0.f, 0.f, 1.f);
    _light1_core->setBeacon(light1_beacon);
    _light1_core->setShadowIntensity(0.7f);
    ...
    */
    ...
    _light2_core->setAmbient(0.15f, 0.15f, 0.15f, 1.f);
    _light2_core->setDiffuse(0.4f, 0.4f, 0.4f, 1.f);
    ...
    OSG::NodeUnrecPtr light2_beacon = OSG::makeCoredNode<OSG::Transform> (&_light2_trans);
    _light2_trans->editMatrix().setTranslate(40.f, 0.f, 40.f);

    _light2_core->setAmbient(0.15f, 0.15f, 0.15f, 1);
    _light2_core->setDiffuse(0.4f, 0.4f, 0.4f, 1);
    _light2_core->setSpecular(0.f, 0.f, 0.f, 1);
    _light2_core->setBeacon(light2_beacon);
