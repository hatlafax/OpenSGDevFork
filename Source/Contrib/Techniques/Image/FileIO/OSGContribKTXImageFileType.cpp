...
static const OSG::Char8 *cmimeType = "image/ktx";
...
/*! \class ContribKTXImageFileType 

  Image File Type to read/write and store/restore Image objects as
  KTX data. Should work with binary and ascii dds/pbm/pgm/ppm data.
...
*/
/*
ContribKTXImageFileType ContribKTXImageFileType::_the(cmimeType,
                                                      suffixArray, 
                                                      sizeof(suffixArray),
                                                      (OSG_READ_SUPPORTED | 
                                                       OSG_WRITE_SUPPORTED));
...
bool ContribKTXImageFileType::read(      Image        *pImage, 
                                         std::istream &is, 
...
bool ContribKTXImageFileType::write(const Image        *, 
                                      std::ostream &, 
                                const std::string  &)
{
    return false;
...
std::string ContribKTXImageFileType::determineMimetypeFromStream(std::istream &is)
{
    char filecode[4];
    ...
    return strncmp(filecode, "KTX ", 4) == 0 ?
        std::string(getMimeType()) : std::string();
}

/**constructors & destructors**/

ContribKTXImageFileType::ContribKTXImageFileType() :
...
ContribKTXImageFileType::ContribKTXImageFileType(const Char8  *mimeType,
...
ContribKTXImageFileType::~ContribKTXImageFileType(void)
{
}
