...
#ifndef _OSGDESCMATERIALFACTORYBASE_H_
#define _OSGDESCMATERIALFACTORYBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief DescMaterialFactory Base Class.

class OSG_CONTRIBTECHNIQUES_DLLMAPPING DescMaterialFactoryBase : public MaterialFactory
{
  public:

    typedef MaterialFactory Inherited;
    typedef MaterialFactory ParentContainer;

    typedef Inherited::TypeObject TypeObject;
    typedef TypeObject::InitPhase InitPhase;

    OSG_GEN_INTERNALPTR(DescMaterialFactory);
  ...
  public:
    ...
    enum
    {
        ...
        VertMaterialBindingPntFieldId = EnvironmentDescFieldId + 1,
    ...
    static  DescMaterialFactoryTransitPtr  create          (void);
    static  DescMaterialFactory           *createEmpty     (void);

    static  DescMaterialFactoryTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  DescMaterialFactory            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  DescMaterialFactoryTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    DescMaterialFactoryBase(void);
    DescMaterialFactoryBase(const DescMaterialFactoryBase &source);
    ...
    virtual ~DescMaterialFactoryBase(void);
    ...
    void onCreate(const DescMaterialFactory *source = NULL);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      DescMaterialFactoryBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const DescMaterialFactoryBase &source);
};

typedef DescMaterialFactoryBase *DescMaterialFactoryBaseP;

OSG_END_NAMESPACE

#endif /* _OSGDESCMATERIALFACTORYBASE_H_ */
