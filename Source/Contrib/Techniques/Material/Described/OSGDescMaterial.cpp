...
*/
    ...
    << endl << "    outLight.directDiffuse  += irradiance * BRDF_Diffuse_Disney (material.diffuse,  material.alphaRoughness);"
    << endl << "    outLight.directSpecular += irradiance * BRDF_Specular_GGX   (material.specular, material.alphaRoughness);"
    << endl << "}"
    << endl << ""
    ;
