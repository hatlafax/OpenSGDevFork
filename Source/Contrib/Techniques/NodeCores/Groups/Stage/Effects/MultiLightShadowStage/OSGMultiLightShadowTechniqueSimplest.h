...
#ifndef _OSGMULTILIGHTSHADOWTECHNIQUESIMPLEST_H_
#define _OSGMULTILIGHTSHADOWTECHNIQUESIMPLEST_H_
#ifdef __sgi
#pragma once
#endif
...
/*! \ingroup GrpEffectsGroupsMultiLightShadowTechniqueSimplest
 */

class OSG_CONTRIBTECHNIQUES_DLLMAPPING MultiLightShadowTechniqueSimplest 
...
public:
    ...
    /*! \name                  Constructors                                */
    /*! \{                                                                 */
    MultiLightShadowTechniqueSimplest(
    ...
    virtual ~MultiLightShadowTechniqueSimplest();
...
private:
    ...
    CubeTextureObjChunkUnrecPtr _pointLightTexObj;
    //SamplerObjChunkUnrecPtr   _pointLightSampleObj;
    ImageUnrecPtr               _pointLightImgPX;
    ImageUnrecPtr               _pointLightImgMX;
    ImageUnrecPtr               _pointLightImgPY;
    ImageUnrecPtr               _pointLightImgMY;
    ImageUnrecPtr               _pointLightImgPZ;
    ImageUnrecPtr               _pointLightImgMZ;
...
#include "OSGMultiLightShadowTechniqueSimplest.inl"

#endif /* _OSGMULTILIGHTSHADOWTECHNIQUESIMPLEST_H_ */
