...
#ifndef _OSGCOREGLWINDOWBASE_H_
#define _OSGCOREGLWINDOWBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief CoreGLWindow Base Class.

class OSG_WINDOWCOREGL_DLLMAPPING CoreGLWindowBase : public Window
{
  public:
  ...
  public:
    ...
    /*! \{                                                                 */
            ...
            void setContext        (const CGLContextObj &value);
    ...
    static  CoreGLWindow           *createEmpty     (void);
  ...
  protected:
    ...
    CoreGLWindowBase(void);
    CoreGLWindowBase(const CoreGLWindowBase &source);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      CoreGLWindowBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const CoreGLWindowBase &source);
};

typedef CoreGLWindowBase *CoreGLWindowBaseP;
