...
inline
OSG::FieldContainerType &GeoIntegralBufferRefPropertyBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 GeoIntegralBufferRefPropertyBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 GeoIntegralBufferRefPropertyBase::getClassGroupId(void)
{
...
inline
void GeoIntegralBufferRefPropertyBase::execSync (      GeoIntegralBufferRefPropertyBase *pFrom,
...
inline
const Char8 *GeoIntegralBufferRefPropertyBase::getClassname(void)
{
    return "GeoIntegralBufferRefProperty";
}
