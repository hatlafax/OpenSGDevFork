...
inline
OSG::FieldContainerType &GeoVectorBufferRefPropertyBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 GeoVectorBufferRefPropertyBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 GeoVectorBufferRefPropertyBase::getClassGroupId(void)
{
...
inline
void GeoVectorBufferRefPropertyBase::execSync (      GeoVectorBufferRefPropertyBase *pFrom,
...
inline
const Char8 *GeoVectorBufferRefPropertyBase::getClassname(void)
{
    return "GeoVectorBufferRefProperty";
}
